...
{
    private static String TAG = "TSAClient"; 
    ...
    {
        Log.d(TAG, "Opening connection to TSA server");
        ...
        {
            Log.e(TAG, "Exception when writing to " + this.url, ex);
            throw ex;
        }
        finally
        {
        ...
        {
            Log.e(TAG, "Exception when reading from " + this.url, ex);
            throw ex;
        }
        finally
        {
        ...
        Log.d(TAG, "Received response from TSA server");
