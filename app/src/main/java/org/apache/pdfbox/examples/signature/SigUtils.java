...
public class SigUtils
{
            ...
            throws CertificateParsingException
    {
        ...
        if (keyUsage != null && !keyUsage[0] && !keyUsage[1])
        {
            ...
            Log.e(TAG, "Certificate key usage does not include " +
        ...
        {
            Log.e(TAG, "Certificate extended key usage does not include " +
            ...
            throws CertificateParsingException
    {
        ...
        {
            Log.e(TAG, "Certificate extended key usage does not include timeStamping");
        }
    }
            ...
            throws CertificateParsingException
    {
        ...
        {
            Log.e(TAG, "Certificate extended key usage does not include OCSP responding");
        }
    }
    ...
    public static void checkCrossReferenceTable(PDDocument doc)
    {
        ...
        if (set.size() != set.last().getNumber())
        {
            ...
            for (COSObjectKey key : set)
            {
                ...
                {
                    Log.w(TAG,"Object " + n + " missing, signature verification may fail in " +
    ...
    public static InputStream openURL(String urlString) throws MalformedURLException, IOException
    {
        ...
        Log.i(TAG, responseCode + " " + con.getResponseMessage());
